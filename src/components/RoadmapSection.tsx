...
export function RoadmapSection() {
  ...
  return (
    <section
      id="roadmap"
      ref={sectionRef}
      className="relative flex w-full min-w-0 min-h-[100dvh] items-start justify-center px-4 pb-16 pt-[max(3.5rem,env(safe-area-inset-top))] sm:px-5 md:min-h-screen md:items-start md:px-10 md:pb-24 md:pt-[min(18vh,10.5rem)] lg:px-14"
    >
      <div
        ref={timelineRef}
